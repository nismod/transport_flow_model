...
| ws1-07 | [ws1-07-pyo3-arrow-bindings.md](ws1-07-pyo3-arrow-bindings.md) | WS1-07: PyO3 bindings with zero-copy Arrow I/O and pure-Python fallback | ws1-routing, rust, python | M2 Routing engine (CCH/PHAST) | **Partly** — Arrow C-stream I/O and long-lived handles done; no CCH, no GIL release, no pure-Python fallback |
